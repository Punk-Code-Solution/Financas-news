...
DEFAULT_AFFILIATES: list[AffiliateItem] = [
    {
        "id": "binance",
        "nome": "Binance",
        "titulo": "Corretora para operar cripto",
        "descricao": "Conheça a plataforma citada no contexto desta análise (parceiro afiliado).",
        "cta": "Ver plataforma",
        "url": "",
        "destaque": True,
        "cor": "yellow",
    },
    {
        ...
        "titulo": "Corretora para bolsa e fundos",
        "descricao": "Opção de conta completa para quem acompanha a análise desta matéria (parceiro afiliado).",
        "cta": "Conhecer corretora",
        "url": "",
        "destaque": False,
        "cor": "blue",
    },
    {
        ...
        "titulo": "Exchange brasileira de cripto",
        "descricao": "Alternativa nacional citada no contexto editorial (parceiro afiliado).",
        "cta": "Ver exchange",
        "url": "",
        "destaque": False,
        "cor": "green",
    },
    {
        ...
        "descricao": "Produtos de renda fixa e multimercado relacionados ao tema da análise (parceiro afiliado).",
