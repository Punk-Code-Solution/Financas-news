...
SITE_BRAND_KEYWORDS: list[str] = [
    ...
    "clareza",
    "clarezacapital",
    "portal clareza capital",
    # Marca anterior e grafias (equity de busca)
    "finanças",
    "financas",
    "financa",
    "finanças news",
...
UI: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "meta_home_title": "Clareza Capital | Notícias Financeiras, Economia e Mercado em Tempo Real",
        "meta_home_og_title": "Clareza Capital | Economia, Investimentos e Cripto",
        "meta_home_description": "Clareza Capital (Finanças News / financas news / financas-news): notícias financeiras, economia Brasil, dólar, Selic, IPCA, ações, criptomoedas e análises com dados do Banco Central.",
        "meta_category_title": "{tag} | Clareza Capital — Notícias e Análises",
        "meta_category_og_title": "{tag} | Clareza Capital",
        "meta_category_description": "Notícias e análises de {tag} no Clareza Capital: economia Brasil, mercado e indicadores oficiais com dados do Banco Central.",
        "meta_search_title": "Busca | Clareza Capital",
        "meta_brand_keywords": ", ".join(SITE_BRAND_KEYWORDS),
        "seo_topics_title": "Temas em destaque",
        "seo_discover_blurb": "Encontre no Clareza Capital análises sobre economia brasileira, mercado financeiro, investimentos, dólar, juros, inflação, criptomoedas, fintech e commodities — atualizadas com dados oficiais.",
        ...
        "footer_tagline": "Análises financeiras com dados do Banco Central, cotações e cruzamento de fontes — Clareza Capital (Finanças News / financas news / financas-news).",
        "footer_portal": "Portal",
        "footer_connect": "Conecte-se",
        "footer_guides": "Guias essenciais",
        "footer_about_title": "Sobre nós",
        "footer_about_blurb": "O Clareza Capital (também Finanças News / financas news / financas-news) publica análises com dados de mercado e indicadores oficiais para ajudar você a entender o que move a economia.",
        ...
        "meta_market_description": "Painel de mercado do Clareza Capital: Selic, IPCA, dólar, Bitcoin e histórico recente com dados oficiais.",
        ...
        "about_meta_title": "Quem Somos | Clareza Capital — Economia e Mercado",
        "about_meta_description": "Conheça o Clareza Capital (Finanças News / financas news / financas-news): notícias financeiras, economia Brasil, Selic, IPCA, dólar, ações e criptomoedas com dados do Banco Central.",
        "privacy_title": "Política de Privacidade",
        "privacy_meta_title": "Política de Privacidade | Clareza Capital",
        "privacy_meta_description": "Saiba como o Clareza Capital (Finanças News / financas news) coleta, utiliza e protege dados pessoais.",
    ...
    "en": {
        ...
        "brand_news": "CAPITAL",
        "site_name": "Clareza Capital",
        "meta_home_title": "Clareza Capital | Financial News, Markets and Economy",
        "meta_home_og_title": "Clareza Capital | Economy, Investing and Crypto",
        "meta_home_description": "Clareza Capital (Finanças News / financas news / financas-news): financial news, Brazilian economy, FX, rates, stocks, crypto and analysis with official market data.",
        "meta_category_title": "{tag} | Clareza Capital — News and Analysis",
        "meta_category_og_title": "{tag} | Clareza Capital",
        "meta_category_description": "{tag} news and analysis on Clareza Capital: Brazilian economy, markets and official indicators.",
        "meta_search_title": "Search | Clareza Capital",
        "meta_brand_keywords": ", ".join(SITE_BRAND_KEYWORDS),
        "seo_topics_title": "Featured topics",
        "seo_discover_blurb": "On Clareza Capital find analysis of the Brazilian economy, financial markets, investing, USD/BRL, interest rates, inflation, crypto, fintech and commodities — with official data.",
        ...
        "footer_tagline": "Financial news and analysis with central-bank data, FX, rates, stocks and crypto — Clareza Capital (Finanças News / financas news / financas-news).",
        "footer_portal": "Site",
        "footer_connect": "Connect",
        "footer_guides": "Essential guides",
        "footer_about_title": "About us",
        "footer_about_blurb": "Clareza Capital (also Finanças News / financas news / financas-news) covers Brazilian economy, markets, investing, USD/BRL, Selic, IPCA and crypto with official data.",
        ...
        "meta_market_description": "Clareza Capital market board: Selic, IPCA, USD/BRL, Bitcoin and recent history from official sources.",
        ...
        "about_meta_title": "About Us | Clareza Capital — Markets and Economy",
        "about_meta_description": "About Clareza Capital (Finanças News / financas news / financas-news): financial news, Brazilian economy, FX, rates, stocks and crypto with official market data.",
    ...
    "ja": {
        ...
        "brand_news": "CAPITAL",
        "site_name": "Clareza Capital",
        "meta_home_title": "Clareza Capital | 金融ニュース・経済・市場",
        "meta_home_og_title": "Clareza Capital | 経済・投資・暗号資産",
        "meta_home_description": "Clareza Capital（Finanças News / financas news / financas-news）：ブラジル経済、為替、金利、株式、暗号資産のニュースと公式データに基づく分析。",
        "meta_category_title": "{tag} | Clareza Capital — ニュースと分析",
        "meta_category_og_title": "{tag} | Clareza Capital",
        "meta_category_description": "Clareza Capitalの{tag}ニュースと分析：ブラジル経済、市場、公式指標。",
        "meta_search_title": "検索 | Clareza Capital",
        "meta_brand_keywords": ", ".join(SITE_BRAND_KEYWORDS),
        "seo_topics_title": "注目トピック",
        "seo_discover_blurb": "Clareza Capitalではブラジル経済、金融市場、投資、ドル、金利、インフレ、暗号資産、フィンテック、コモディティの分析を公式データとともに配信します。",
        ...
        "back": "戻る",
        "footer_developed": "開発:",
        "footer_tagline": "ブラジル経済、為替、金利、株式、暗号資産のニュースと分析 — Clareza Capital（Finanças News / financas news / financas-news）。",
        "footer_portal": "サイト",
        "footer_connect": "つながる",
        "footer_guides": "基本ガイド",
        "footer_about_title": "私たちについて",
        "footer_about_blurb": "Clareza Capital（Finanças News / financas news / financas-news）はブラジル経済、市場、投資、ドル、Selic、IPCA、暗号資産を公式データとともに解説します。",
        ...
        "meta_market_description": "Clareza Capitalの市場パネル：Selic、IPCA、ドル、ビットコインと公式データの履歴。",
        ...
        "about_title": "私たちについて",
        "about_meta_title": "私たちについて | Clareza Capital — 経済と市場",
        "about_meta_description": "Clareza Capital（Finanças News / financas news / financas-news）：ブラジル経済、為替、金利、株式、暗号資産のニュースと公式データに基づく分析。",
