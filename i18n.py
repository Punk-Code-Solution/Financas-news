...
UI: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "nav_market": "Mercado",
        "meta_market_title": "Mercado em tempo real | Selic, IPCA, Dólar e Bitcoin — Finanças News",
        "meta_market_description": "Painel de mercado do Finanças News: Selic, IPCA, dólar, Bitcoin e histórico recente com dados oficiais.",
    ...
    "en": {
        ...
        "nav_privacy": "Privacy",
        "nav_market": "Markets",
        "meta_market_title": "Live markets | Selic, IPCA, USD and Bitcoin — Finanças News",
        "meta_market_description": "Finanças News market board: Selic, IPCA, USD/BRL, Bitcoin and recent history from official sources.",
    ...
    "ja": {
        ...
        "nav_privacy": "プライバシー",
        "nav_market": "マーケット",
        "meta_market_title": "リアルタイム市場 | Selic・IPCA・ドル・ビットコイン — Finanças News",
        "meta_market_description": "Finanças Newsの市場パネル：Selic、IPCA、ドル、ビットコインと公式データの履歴。",
