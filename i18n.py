...
UI: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "meta_home_title": "Finanças News | Notícias em Tempo Real",
        "meta_home_og_title": "Finanças News | O Essencial do Mercado",
        "meta_home_description": "Análises financeiras com dados de mercado, indicadores do Banco Central e cruzamento de fontes.",
        ...
        "footer_tagline": "Análises financeiras com dados do Banco Central, cotações e cruzamento de fontes.",
        "footer_portal": "Portal",
        "footer_connect": "Conecte-se",
        "footer_guides": "Guias essenciais",
        "footer_about_title": "Sobre nós",
        "footer_about_blurb": "O Finanças News publica análises com dados de mercado e indicadores oficiais para ajudar você a entender o que move a economia.",
        ...
        "about_meta_title": "Quem Somos - Finanças News",
        "about_meta_description": "Conheça o Finanças News: análises financeiras com dados do Banco Central, cotações e cruzamento de fontes para o investidor brasileiro.",
        "privacy_title": "Política de Privacidade",
        "privacy_meta_title": "Política de Privacidade | Finanças News",
        "privacy_meta_description": "Saiba como o Finanças News coleta, utiliza e protege dados pessoais.",
    ...
    "en": {
        ...
        "brand_news": "NEWS",
        "site_name": "Finanças News",
        "meta_home_title": "Finanças News | Real-Time Market News",
        "meta_home_og_title": "Finanças News | What Matters in the Markets",
        "meta_home_description": "Financial analysis with market data, central-bank indicators and multi-source context.",
        ...
        "footer_tagline": "Financial analysis with central-bank data, market quotes and multi-source context.",
        "footer_portal": "Site",
        "footer_connect": "Connect",
        "footer_guides": "Essential guides",
        "footer_about_title": "About us",
        "footer_about_blurb": "Finanças News publishes analysis with market data and official indicators to help you understand what moves the economy.",
        ...
        "about_meta_title": "About Us - Finanças News",
        "about_meta_description": "About Finanças News: financial analysis with central-bank data, market quotes and multi-source context for investors.",
    ...
    "ja": {
        ...
        "brand_news": "NEWS",
        "site_name": "Finanças News",
        "meta_home_title": "Finanças News | リアルタイム金融ニュース",
        "meta_home_og_title": "Finanças News | 市場の要点",
        "meta_home_description": "市場データ、中央銀行指標、複数ソースの照合に基づく金融分析。",
        ...
        "back": "戻る",
        "footer_developed": "開発:",
        "footer_tagline": "中央銀行データ、市場相場、複数ソースの照合に基づく金融分析。",
        "footer_portal": "サイト",
        "footer_connect": "つながる",
        "footer_guides": "基本ガイド",
        "footer_about_title": "私たちについて",
        "footer_about_blurb": "Finanças Newsは市場データと公的指標に基づく分析を発信し、経済の動きを理解する手助けをします。",
        ...
        "about_title": "私たちについて",
        "about_meta_title": "私たちについて - Finanças News",
        "about_meta_description": "Finanças Newsについて：中央銀行データ、市場相場、複数ソースの照合に基づく金融分析。",
