...
UI: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "lang_en": "EN",
        "lang_ja": "JA",
        "content_original_notice": "Esta análise foi publicada originalmente em português. A interface está em {lang}.",
    ...
    "en": {
        ...
        "lang_en": "EN",
        "lang_ja": "JA",
        "content_original_notice": "This analysis was originally published in Portuguese. The interface is in {lang}.",
    ...
    "ja": {
        ...
        "lang_en": "EN",
        "lang_ja": "JA",
        "content_original_notice": "この分析はポルトガル語で公開されています。現在の表示言語は{lang}です。",
